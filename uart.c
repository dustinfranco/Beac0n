 ...
 */
 ...
 // Dual mode version  modified by Jeff Melville
 // Can operate in normal TX blocking mode, or using a circular buffer
 // Comment out this define to go back to the normal way:
...
#else   //use the old "blocking" putchar
/*
